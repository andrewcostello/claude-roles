...
// CONSTRAINTS:
//
//   - admitForWrite is the ONLY path from ApplyRoundRecord's output to
//     os.WriteFile. GO-4-3 wires appendRound as LoadRunStateDocument ->
//     ApplyRoundRecord -> admitForWrite -> os.WriteFile. A second route to the
...
//     (recordAndReport / cmdRun) and is not decided here.
